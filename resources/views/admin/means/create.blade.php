            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        <form method="POST" action="{{ route('means.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="min_value"
                                                id="min_value" value="{{ old('min_value') }}" autocomplete="min_value"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="max_value"
                                                id="max_value" value="{{ old('max_value') }}" autocomplete="max_value"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>

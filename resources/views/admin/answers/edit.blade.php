                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <select name="type" type="text"
                                                ...
                                                value="{{ $answer->type ?? '' }}" required>
                                                @if ($errors->has('type'))
                                                    <p class="text-danger">{{ $errors->first('type') }}</p>
                                                @endif
                                                <option value=''> -- Pilih Type Jwaban-- </option>
                                                <option value='text' {{ $answer->type == 'text' ? 'selected' : '' }}> Text
                                                </option>
                                                <option
                                                    value='selection'{{ $answer->type == 'selection' ? 'selected' : '' }}>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="notes" id="notes"
                                                value="{{ $answer->notes ?? '' }}" autocomplete="notes"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>

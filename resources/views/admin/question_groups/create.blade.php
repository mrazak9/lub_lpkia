            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                <div class="col-span-12">
                    <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
                        Input Master Grup Pertanyaan : {{ $question->name }}
                    </h2>
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        <form method="POST" action="{{ route('question_groups.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="name" class="block mb-3 font-medium text-gray-700 text-md">Nama
                                                Grup Jawaban</label>
                                            <input placeholder="Your Group Name" type="text" name="name"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your notes Answer" type="text" name="notes"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            <input name="id_question" id="id_question" value={{ $question->id }}
                                                autocomplete="id_question" hidden>
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href={{ route('questions.add_group', $question->id) }} type="button"

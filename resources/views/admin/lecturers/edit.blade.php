                        ...
                        <form method="POST" action="{{ route('lecturers.update', $lecturer->id) }}"
                            ...
                            <div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="name" id="name"
                                                value="{{ $lecturer->user->name ?? '' }}" autocomplete="name"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="code"
                                                class="block mb-3 font-medium text-gray-700 text-md">NIP/NIDN</label>
                                            <input placeholder="Your Min Value" type="text" name="code" id="code"
                                                value="{{ $lecturer->code ?? '' }}" autocomplete="code"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="email" id="email"
                                                value="{{ $lecturer->user->email ?? '' }}" autocomplete="email"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href={{ route('lecturers.index') }} type="button"

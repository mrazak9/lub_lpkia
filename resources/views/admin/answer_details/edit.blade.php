            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        <form method="POST" action="{{ route('answer_details.update', $answerDetail->id) }}"
                            ...
                            <div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="name" id="name"
                                                value="{{ $answerDetail->name ?? '' }}" autocomplete="name"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Your Min Value" type="text" name="code" id="code"
                                                value="{{ $answerDetail->code ?? '' }}" autocomplete="code"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="value"
                                                class="block mb-3 font-medium text-gray-700 text-md">Keterangan</label>
                                            <input placeholder="Your Min Value" type="number" name="value" id="value"
                                                value="{{ $answerDetail->value ?? '' }}" autocomplete="value"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                required>
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    <a href={{ route('answers.show', $answerDetail->id_answer)}} type="button"
